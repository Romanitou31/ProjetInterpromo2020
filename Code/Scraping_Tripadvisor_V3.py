    ...
    for company in range(5):
        ...
        for page in range(nb_pages):
            ...
            for block in results:
                ...
                pivot_date = format_date(Date_Convertion(date_review)) >= (datetime.now() - timedelta(n_days))
...
Lets_Scrape(1,'/Users/julesboutibou/Documents/L3 Cours/Projet/Données/phantomjs-2.1.1-macosx/bin/phantomjs','df_compagnies.csv')

#with open('/Users/julesboutibou/Documents/L3 Cours/Projet/Données/TestTripAdvisor.json') as train_file:
